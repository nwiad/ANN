...
parser.add_argument('--batch_norm', type=int, default=1,
	help='Whether to use batch normalization. Default: 1')
parser.add_argument('--dropout', type=int, default=1,
	help='Whether to use dropout. Default: 1')
args = parser.parse_args()

print(f"batch_size={args.batch_size}, drop_rate={args.drop_rate}")
wandb.init(
	project="cnn",
	config={
	...
	name=f'cnn_{args.batch_size}_{args.drop_rate}_{args.learning_rate}'
)
...
if __name__ == '__main__':
	...
	if args.is_train:
		...
		cnn_model = Model(drop_rate=args.drop_rate, batch_norm=args.batch_norm, dropout=args.dropout)
		cnn_model.to(device)
		print(cnn_model)
	...
	plot(axis, train_acc_list, train_loss_list, val_acc_list, val_loss_list, args.batch_size, args.drop_rate, args.learning_rate)
	with open("final_test_acc.txt", "a") as f:
		f.write("batch_size: {}, drop_rate: {}, learning_rate: {}, final_test_acc: {}\n".format(args.batch_size, args.drop_rate, args.learning_rate, final_test_acc))