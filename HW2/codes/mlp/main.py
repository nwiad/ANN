...
wandb.init(
	...
	name=f'mlp_{args.batch_size}_{args.drop_rate}_{args.learning_rate}'
)
...
if __name__ == '__main__':
	...
	if args.is_train:
		...
		mlp_model = Model(drop_rate=args.drop_rate, batch_norm=args.batch_norm, dropout=args.dropout)
		mlp_model.to(device)
		print(mlp_model)
